...
/*
 *  Adds validity to a form or container to be run when validity if fired.
 *
 *  @param jQueryObject $form
 *  @param string outputMode
 *  @param function specialValidation
 *  @param boolean skipAutoValidity
 *  @param object setupSettings
 *  
 *  @return void
 *  
 *  @deprecated: 1.0
 ...
 *  @param: integer duration (in miliseconds)
 *  @param: string templateId 
 */
function flashMessage(message, className, duration, templateId) {
